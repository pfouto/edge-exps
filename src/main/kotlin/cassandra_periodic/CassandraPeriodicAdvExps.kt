...
suspend fun runCassandraPeriodicAdv(expYaml: YamlNode, proxies: Proxies, dockerConfig: DockerConfig) {
        ...
        expConfig.nodes.forEach { nNodes ->
            ...
            expConfig.periodicModes.forEach { mode ->
                expConfig.readPercents.forEach read@{ readPercent ->
                    ...
                    val logsPath =
                        "${expConfig.name}/${nNodes}n_${mode}_${readPercent}r_cassandra_${tcBaseFileNumber}"
